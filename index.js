...
// Because of the rules of scope the nested function has access to variables that a higher scope.
...
const zooAnimals = [
  ...
  */
  ...
  function lowerCaseNames(zooAnimals){
    const names = zooAnimals.map(function(value) {
  ...
  */
  ...
  function lowPopulationAnimals(zooAnimals){
    const popu = zooAnimals.filter(function(value) {
  ...
  */
  ...
  function USApop(zooAnimals){
    const reducer = zooAnimals.reduce(function(accumulator, item) {
